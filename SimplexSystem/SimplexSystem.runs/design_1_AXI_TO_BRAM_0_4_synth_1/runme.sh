...
HD_PWD='C:/Users/Andrej/VHDL_projects/SimplexSystem/SimplexSystem.runs/design_1_AXI_TO_BRAM_0_4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_AXI_TO_BRAM_0_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_AXI_TO_BRAM_0_4.tcl
